...
export default function HomePage() {
  ...
  return <div className="min-h-screen pb-20 bg-[#e9e7fd]">
      ...
      {!canInteract && <div className="bg-warning/20 px-4 py-3 flex items-center gap-2 text-warning border-b border-warning/30">
      ...
      <header className="sticky top-0 z-40">
        {/* Main header bar */}
        <div className="bg-gradient-to-b from-[#2d1b4e] to-[#251542] px-4 pb-0 pt-0">
