          ...
          friend
                ...
                <div className={`w-[68px] h-[68px] rounded-full p-[3px] bg-gradient-to-br from-purple-400 via-purple-500 to-teal-400 ${selectedFriendId === friend.id ? 'ring-2 ring-purple-600 ring-offset-2' : ''}`}>
                  <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    {friend.avatar_snapshot_url ? <img src={friend.avatar_snapshot_url} alt={friend.nick} className="w-full h-full object-cover" /> : <span className="text-2xl">{FRIEND_EMOJIS[index % FRIEND_EMOJIS.length]}</span>}
                  </div>
                </div>
        ...
        {postsLoading ? <>
            ...
            {selectedFriendId ? <p>Este amigo aún no tiene publicaciones</p> : <p>No hay publicaciones. ¡Sé el primero en publicar!</p>}
              ...
              <div className="px-4 py-3">
                ...
                {/* Likes count */}
                {post.likes_count > 0 && <p className="mt-2 text-sm font-semibold text-gray-900">
