    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        <motion.button
          ...
          className="btn-gaming py-4 rounded-2xl text-foreground font-gaming text-lg"
        >
          ¡Empezar!
        </motion.button>
        ...
        <motion.button
          ...
          className="py-4 rounded-2xl border-2 border-border/50 text-muted-foreground font-gaming text-lg hover:border-primary/50 hover:text-foreground transition-all"
        >
          Ya tengo cuenta
        </motion.button>
      </motion.div>
