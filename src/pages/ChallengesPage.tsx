...
const todayChallenge = {
  ...
  maxParticipations: 3,
  topParticipants: [
    { rank: 1, nick: "GamerPro", avatar: "🎮", likes: 342 },
    { rank: 2, nick: "ArtistaDigital", avatar: "🎨", likes: 289 },
    { rank: 3, nick: "SkaterKid", avatar: "🛹", likes: 245 },
  ],
};

const rewards = [
  { id: "1", name: "Gorra Épica", emoji: "🧢", rarity: "Épico" },
  { id: "2", name: "Gafas Neón", emoji: "🕶️", rarity: "Raro" },
  { id: "3", name: "Alas Brillantes", emoji: "🦋", rarity: "Legendario" },
];
      ...
      <div className="p-4 space-y-6">
          ...
          <div className="relative p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-1">
                {[...Array(todayChallenge.maxParticipations)].map((_, i) => (
                  <div
                    key={i}
                    className={`w-3 h-3 rounded-full ${
                      i < todayChallenge.myParticipations
                        ? "bg-secondary"
                        : "bg-muted"
                    }`}
                  />
            ...
            <motion.button
              ...
              disabled={todayChallenge.myParticipations >= todayChallenge.maxParticipations}
        ...
        >
          ...
          <div className="space-y-3">
            {todayChallenge.topParticipants.map((participant, index) => (
              <motion.div
                ...
                className={`flex items-center gap-4 p-3 rounded-xl ${
                  ...
                  index === 1 ? "bg-muted/50 border border-border/50" :
            ...
            {rewards.map((reward, index) => (
              ...
              >
                ...
                <p className={`text-[10px] mt-1 ${
                  reward.rarity === "Legendario" ? "text-warning" :
                  reward.rarity === "Épico" ? "text-primary" :
                  "text-secondary"
                }`}>
                  {reward.rarity}
                </p>
