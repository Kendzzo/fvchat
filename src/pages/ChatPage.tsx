...
function ChatDetail({ chat, onBack }: { chat: typeof mockChats[0]; onBack: () => void }) {
  const [message, setMessage] = useState("");

  // Mock messages
  const messages = [
    { id: "1", text: "¡Hola! 👋", isMine: false, time: "10:30" },
    { id: "2", text: "¡Hey! ¿Qué tal?", isMine: true, time: "10:31" },
    { id: "3", text: "Todo bien, ¿jugamos luego?", isMine: false, time: "10:32" },
    { id: "4", text: "¡Claro! ¿A qué hora?", isMine: true, time: "10:33" },
    { id: "5", text: "¿A las 5? 🎮", isMine: false, time: "10:34" },
  ];
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-1">
            <div className="relative">
              ...
              {chat.isOnline && (
                <div className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-secondary border-2 border-background" />
              )}
            </div>
            <div>
